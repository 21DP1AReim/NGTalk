...
-
1. Download [Ruby](https://rubyinstaller.org/downloads/) (Devkit)
2. When you have run the installer and finished the setup, check if ruby has been succesfully setup by this command in the cmd:
```
ruby -v 
```
3. If the command returns a version of ruby, download rails by running this command in the cmd:
```
gem install rails
```
4. Download [Visual studio code](https://code.visualstudio.com)
5. Download the live server extension in VS Code
6. Open the terminal in VS Code and run the command
```
bundle install
```
